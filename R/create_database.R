...
LaTeX: pdfLaTeX' > ", name, ".Rproj"))
    ...
    info <- list(rdough_version = 0.1, date_create = Sys.Date(), last_update = Sys.Date(), accounts = list(accounts = "main", currencies = "EUR"), expenses_defaults = list(date = "today", value = 1, account = "main", situation = "groningen", type = "food", subtype = "groceries", obs = "NA"), incomes_defaults = list(date = "today", value = 1000, account = "main", situation = "groningen", source = "meme_scholarship", obs = NA))
